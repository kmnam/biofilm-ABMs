 ...
 * (2) partitions copies of a plasmid between daughter cells.
 *
 * The groups are assumed to be numbered 1, 2, 3, ..., and the plasmid copy
 * numbers are stored in an additional column. 
 *
 * @param cells Existing population of cells.
 * @param parents Vector of parent cell IDs for each cell generated throughout
 *                the simulation. 
