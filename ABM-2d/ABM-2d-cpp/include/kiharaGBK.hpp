...
/* --------------------------------------------------------------------- //
 *                      FORCES IN 2 OR 3 DIMENSIONSS                     //
 * --------------------------------------------------------------------- */
/**
 * Compute the generalized forces between two neighboring cells that arise
 * from the Kihara potential in arbitrary dimensions (2 or 3).
 *
 ...
 */
template <typename T, int Dim>
std::pair<T, Matrix<T, 2, 2 * Dim> > anisotropyParamGBK1(const Ref<const Matrix<T, Dim, 1> >& n1,
                                                         const T half_l1,
                                                         const Ref<const Matrix<T, Dim, 1> >& n2,
                                                         const T half_l2,
                                                         const T Rcell,
 ...
 */
template <typename T, int Dim>
std::pair<T, Matrix<T, 2, 2 * Dim> > anisotropyParamGBK2(const Ref<const Matrix<T, Dim, 1> >& r1, 
                                                         const Ref<const Matrix<T, Dim, 1> >& n1,
                                                         const T half_l1,
                                                         const Ref<const Matrix<T, Dim, 1> >& r2, 
                                                         const Ref<const Matrix<T, Dim, 1> >& n2,
...
/**
 * Compute the generalized forces between two neighboring cells that arise
 * from the Gay-Berne-Kihara potential in arbitrary dimensions (2 or 3).
 *
                                  ...
                                  const T exp2, const T kappa0, const T dmin)
{
    ...
    auto result2 = anisotropyParamGBK2<T, Dim>(
