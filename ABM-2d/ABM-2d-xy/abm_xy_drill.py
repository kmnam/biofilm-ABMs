"""
A variant of the default simulation that accumulates a population of cells,
stops cell growth in the core of the biofilm ("drills a hole"), and restarts
the simulation. 
...
if __name__ == '__main__':
    ...
    # Seed the simulation ...
    while t < t_final and cells.shape[0] < n_seed:
    ...
    # Kill the 50% of cells nearest to the biofilm center
    center = cells[:, :2].sum(axis=0) / cells.shape[0]
    n_kill = int(cells.shape[0] / 2)
    distances = np.sqrt(
