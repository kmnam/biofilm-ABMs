/**
 * Test simulations with one vertical non-growing cell. 
 * 
 * Authors:
 *     Kee-Myoung Nam
 *
 ...
 *                             TEST MODULES                            //
 * ------------------------------------------------------------------- */
TEST_CASE("Test simulations with vertical cells", "[runSimulationAdaptiveLagrangian()]")
{
    ...
    // Case 1: A vertical cell in which the cell is just touching the surface
    Array<T, 3, 1> r, n;
    r << 0.0, 0.0, half_l + 0.999 * R;
    n << 0.0, 0.0, 1.0;
