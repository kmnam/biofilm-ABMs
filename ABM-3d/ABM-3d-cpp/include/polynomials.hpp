 ...
 *
 * This class assumes a real-valued coefficient type T for which one can
 * define std::complex<T>. 
 */
...
class HighPrecisionPolynomial
{
    ...
    typedef boost::multiprecision::number<boost::multiprecision::mpc_float_backend<N> >  ComplexType;
